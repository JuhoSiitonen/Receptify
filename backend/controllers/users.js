...
const subscribeToUser = async (req, res) => {
  try {
    ...
    const subscriptions = JSON.parse(req.session.subscriptions)
...
const unsubscribeFromUser = async (req, res) => {
  try {
    ...
    const sunscriptions = JSON.parse(req.session.subscriptions)
...
const addAsFavorite = async (req, res) => {
  try {
    const { id } = req.params
    const favorites = JSON.parse(req.session.userFavorites)
...
const addToShoppinglist = async (req, res) => {
  try {
    ...
    const shoppinglist = JSON.parse(req.session.shoppinglist)
